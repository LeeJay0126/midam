...
const MenuTypeList = [
    ...
    ["SIGNATURE", [
        ...
        ["question.jpeg", "Picture of Kimchi Dumpling Hotpot", "$38", "Kimchi Dumpling Hotpot", true],
        ["question.jpeg", "Picture of BBG mushroom hotpot", "$42", "'Bulgoki' Mushroom Hotpot"],
        ["question.jpeg", "Picture of pork backbone soup hotpot", "$42", "Spicy Pork Back Bone Hotpot", true],
    ], true, "Includes 2 bowls of Rice"],
    ["SOUPS", [
        ["spKimchiPorkSoup.webp", "Picture of kimchipork soup", "$16", "Kimchi and Pork Tofu Soup", true],
        ...
        ["question.jpeg", "Picture of curry kimchi porkbelly soup", "$16", "Curry Kimchi Tofu Soup",true],
        ["question.jpeg", "Picture of curry seafood tofu soup", "$18", "Curry Seafood Tofu Soup", true],
        ...
        ["question.jpeg", "Picture of seafood soy soup", "$17", "Seafood Soy Bean Stew", true],
    ...
    ["RICE BOWL", [
        ...
        ["question.jpeg", "Picture of spbbb", "$18", "BBQ Pork 'Bulgogi' Stone Pot Bibimbap", true],
        ...
        ["question.jpeg", "Picture of sp chicken Stone pot", "$18", "Spicy Chicken Stone Pot Bibimbap", true],
        ["question.jpeg", "Picture of chicken Stone pot", "$18", "Soy Garlic Chicken Stone Pot Bibimbap"],
    ...
    ["VEGETARIAN", [
        ...
        ["question.jpeg", "Picture of Vegetarian Kimchi Tofu Soup", "$14", "Vegetarian Kimchi Tofu Soup", true],
        ["question.jpeg", "Picture of Vegetarian Curry Kimchi Tofu Soup", "$15", "Vegetarian Curry Kimchi Tofu Soup", true],
        ["question.jpeg", "Picture of Vegetarian Kimchi Yaki Udon", "$13", "Vegetarian Kimchi Yaki Udon", true],
        ["question.jpeg", "Picture of Vegetarian Kimchi Fried Rice", "$14", "Vegetarian Kimchi Fried Rice",true],
